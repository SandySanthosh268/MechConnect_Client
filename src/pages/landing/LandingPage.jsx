...
const OIL_CHANGE_IMAGE = "https://images.unsplash.com/photo-1635830635487-709ea93e6205?auto=format&fit=crop&q=80&w=800";
const BRAKE_REPAIR_IMAGE = "https://images.unsplash.com/photo-1600880292203-757bb62b4baf?auto=format&fit=crop&q=80&w=800";
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  <Button size="lg" className="h-16 px-10 text-lg shadow-2xl font-black uppercase tracking-widest" onClick={() => navigate('/register')}>
                    Book a Mechanic Now <ChevronRight size={20} className="ml-1" />
                  </Button>
                  <Button size="lg" variant="outline" className="h-16 px-10 text-lg bg-white font-black uppercase tracking-widest" onClick={() => navigate('/register')}>
                    Become a Mechanic
                  </Button>
                </div>
              </motion.div>
        ...
        <section id="how-it-works" className="py-24 bg-white">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-black text-slate-900 dark:text-white mb-4 tracking-tight">How It Works</h2>
              <p className="text-slate-600 dark:text-slate-400 max-w-xl mx-auto font-semibold">Get your vehicle fixed in 4 simple steps without the hassle of waiting at the garage.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              {steps.map((step) => (
                <div key={step.id} className="relative group">
                  <div className="p-8 rounded-[32px] bg-slate-50 border border-slate-100 group-hover:border-primary/20 group-hover:bg-primary/5 transition-all duration-300">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed font-medium">{step.desc}</p>
                    <div className="absolute -top-4 -right-4 text-7xl font-black text-slate-100 dark:text-slate-800/50 group-hover:text-primary/10 transition-colors -z-10 select-none">
                      0{step.id}
                    </div>
                  </div>
                </div>
